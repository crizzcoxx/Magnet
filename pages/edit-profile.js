...
class EditProfile extends React.Component {
  ...
  render() {
    ...
    const { name, email, avatar, avatarPreview, about, isLoading, isSaving, updatedUser, openSuccess, openError, error } = this.state;
    ...
    return (
      <div className={classes.root}>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
             {updatedUser && updatedUser.name} was successfully updated!
            </DialogContentText>
          </DialogContent>
        </Dialog>
      </div>
